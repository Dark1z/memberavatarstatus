...
/**
 * Member Avatar & Status [MAS] ACP controller Review.
 */
class acp_review extends acp_base
{
	/** @var config */
	protected $config;
	...
	/**
	 * Display the options a user can configure for Review Mode.
	 *
	 * @return void
	 * @access public
	 */
	public function handle()
	{
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			$this->config->set('dark1_mas_rv_av', $this->request->variable('dark1_mas_rv_av', 0));
			$this->config->set('dark1_mas_rv_ol', $this->request->variable('dark1_mas_rv_ol', 0));
			$this->config->set('dark1_mas_rv_av_sz', $this->avatar->mas_get_avatar_size($this->request->variable('dark1_mas_rv_av_sz', avatar::AV_DEF_SZ_SML), avatar::AV_DEF_SZ_SML, avatar::AV_MAX_SZ_SML));
