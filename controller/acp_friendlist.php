...
/**
 * Member Avatar & Status [MAS] ACP controller Friendlist.
 */
class acp_friendlist extends acp_base
{
	/** @var config */
	protected $config;
	...
	/**
	 * Display the options a user can configure for Friendlist Mode.
	 *
	 * @return void
	 * @access public
	 */
	public function handle()
	{
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			$this->config->set('dark1_mas_fl_av', $this->request->variable('dark1_mas_fl_av', 0));
			$this->config->set('dark1_mas_fl_ol', $this->request->variable('dark1_mas_fl_ol', 0));
			$this->config->set('dark1_mas_fl_av_sz', $this->avatar->mas_get_avatar_size($this->request->variable('dark1_mas_fl_av_sz', avatar::AV_DEF_SZ_SML), avatar::AV_DEF_SZ_SML, avatar::AV_MAX_SZ_SML));
