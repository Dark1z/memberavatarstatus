 ...
 *
 * @copyright (c) $mas_func::AV_DEF_SZ_SML18, Dark❶ [dark1]
...
class viewforum_module
{
	...
	public function main($id, $mode)
	{
		...
		if ($request->is_set_post('submit'))
		{
			...
			$config->set('dark1_mas_vf_fp_av_sz', $mas_func->mas_get_avatar_size($request->variable('dark1_mas_vf_fp_av_sz', $mas_func::AV_DEF_SZ_SML), $mas_func::AV_DEF_SZ_SML, $mas_func::AV_MAX_SZ_SML));
			$config->set('dark1_mas_vf_lp_av_sz', $mas_func->mas_get_avatar_size($request->variable('dark1_mas_vf_lp_av_sz', $mas_func::AV_DEF_SZ_SML), $mas_func::AV_DEF_SZ_SML, $mas_func::AV_MAX_SZ_SML));
